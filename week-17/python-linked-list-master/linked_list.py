...
# : Set the `_value` `_next` node instance variables
...
# : Implement a Singly Linked List class here
class LinkedList:
    # : Set the `_head` node, `_tail` node, and list `_length` instance variables
    def __init__(self):
        self._head = None
        self._tail = None
        self._length = 0

    # : Implement the get_node method here

    def get_node(self, position):
        self._next = position

    # : Implement the add_to_tail method here
...
#     # : Implement the add_to_head method here
#     def add_to_head(self, value):
#         pass

#     # : Implement the remove_head method here
#     def remove_head(self):
#         pass

#     # : Implement the remove_tail method here
#     def remove_tail(self):
#         pass

#     # : Implement the __len__ method here
#     def __len__(self):
#         pass

# # Phase 2

#     # : Implement the contains_value method here
#     def contains_value(self, target):
#         pass

#     # : Implement the insert_value method here
#     def insert_value(self, position, value):
#         pass

#     # : Implement the update_value method here
#     def update_value(self, position, value):
#         pass

#     # : Implement the remove_node method here
